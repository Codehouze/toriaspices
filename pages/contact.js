      ...
      <Grid container  justifyContent="center" alignItems="center" sx={{ p: 3 }}>
        <Grid item xs={11} sm={6} lg={7} sx={{ px: 3 }}>
          ...
          <Typography variant="p" component="p">
            <br /> At Toria Spices! We're excited to hear from you. Whether you have questions,
        ...
        <Grid item xs={10} sm={6} lg={5} sx={{ px: 3 }} className="contact">
          ...
          <Grid>
            ...
            component="h3"
            color="primary"
            sx={{ mt: 3, fontSize: 26, mb:3}}>Follow us on our socials</Typography>
            </Grid>
            ...
            <a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=support@toriaspices.com">
                <Email sx={{color:theme.palette.secondary.main,mr:1,'&:hover': {
                    color: theme.palette.primary.main } }} fontSize="large" />
              </a>
            <a href="https://web.facebook.com/toriaspices">
                <Facebook sx={{color:theme.palette.socials.facebook,mr:1,'&:hover': {
                    color: theme.palette.primary.facebook, } }} fontSize="large" />
              </a>
              <a href="https://www.instagram.com/toriaspices/">
                <Instagram sx={{color:theme.palette.socials.instagram,mr:1,'&:hover': {
                    color: theme.palette.primary.main } }} fontSize="large" />
              </a>
              <a href="https://www.youtube.com/channel/UCg4RXb5wsxPrMSDOEmQuwUA">
                <YouTube sx={{color:theme.palette.socials.youtube,mr:1,'&:hover': {
                    color: theme.palette.primary.main} }} fontSize="large" />
              </a>
            </Grid>
          </Grid>
